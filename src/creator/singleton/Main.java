...
public class Main {
    ...
    public static void execute(int ThreadNums,int Task, String objectType) {
        // List 不是线程安全的，可能存在写入覆盖，可能存在读脏数据
